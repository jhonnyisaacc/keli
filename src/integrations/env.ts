...
const FIXTURE_KEYS = {
  ...
  documents: ["KELI_FIXTURE_DOCUMENTS", "KELI_DOCUMENTS_FIXTURE_URL"],
  ocr: ["KELI_FIXTURE_OCR", "KELI_OCR_FIXTURE_URL"],
  speech: ["KELI_FIXTURE_SPEECH", "KELI_SPEECH_FIXTURE_URL"],
} as const;
