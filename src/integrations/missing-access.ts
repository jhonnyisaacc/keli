...
export const SEARCH_MISSING_ACCESS =
  "Search is not connected. Run keli connect search (or keli setup search) to add Brave or a generic JSON endpoint, then retry. Conversation still works without web search.";

export const MCP_MISSING_ACCESS =
  "MCP is not connected. Run keli connect mcp (or keli setup mcp) to add a stdio or HTTP server, or omit mcp.tools/* from this responsibility.";
