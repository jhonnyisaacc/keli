...
const BUILTIN: CapabilityDescriptor[] = [
  ...
  },
  {
    ...
    version: "0.1.0",
    summary: "Extract text from a readable document (text or PDF); optional pdftotext",
    actionClass: "read",
    resources: ["path"],
    schema: {
      type: "object",
  ...
  },
  {
    id: "ocr.extract",
    version: "0.1.0",
    summary: "OCR a readable image via optional Tesseract or a fixture",
    actionClass: "read",
    resources: ["path"],
    schema: {
      type: "object",
  ...
  },
  {
    ...
    version: "0.1.0",
    summary: "Transcribe audio via an OpenAI-compatible endpoint or fixture",
    actionClass: "read",
    resources: ["path"],
    schema: {
      type: "object",
  ...
  },
  {
    ...
    version: "0.1.0",
    summary: "Synthesize speech via an OpenAI-compatible endpoint or fixture (optional)",
    actionClass: "read",
    resources: ["text"],
    schema: {
      type: "object",
      properties: { text: { type: "string" }, model: { type: "string" }, voice: { type: "string" } },
      required: ["text"],
    },
  },
  {
